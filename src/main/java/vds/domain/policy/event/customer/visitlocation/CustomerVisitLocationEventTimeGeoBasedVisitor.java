...
public class CustomerVisitLocationEventTimeGeoBasedVisitor implements CustomerEventPolicyConditionVisitor<CustomerVisitLocationEvent, Promotion> {
    private static final List<CustomerEventPolicyCondition<CustomerVisitLocationEvent, Promotion>> conditions = Arrays.asList(
            new CustomerVisitLocationHcmcAtDayPromotionPolicyCondition(),
            new CustomerVisitLocationHanoiAtNightPromotionPolicyCondition()
    );
